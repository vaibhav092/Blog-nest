...
export class Service{
    ...
    async createPost({title,slug,content,image,status,userid}){
        try {
            ...
            console.log(error,"config:: createpost ");
        }
    ...
    async getPost(slug){
        try {
            ...
            console.log("error config.js::getPost::",error);
        }
    }
    ...
    async getPosts(queries=[Query.equal("status","active")]){
        try {
            ...
            console.log(error,"error::config::getposts");
        }
    }
// file upload
    async uploadFile(file){
        try {
            ...
            console.log("Upload file :: confid",error);
        }
    }
    ...
    async deleteFile(fileId){
        try {
            ...
            console.log("error ::deleteFile::config",error);
        }
    }
